        ...
        <div className='flex flex-col w-full'>
          ...
          <div className='flex flex-col w-2/3 h-full'>
            <form onSubmit={handleSubmit}>
              ...
              <div className="relative z-0 w-full mb-6 group">
                <textarea id="floating_msg" rows={4} className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " onChange={(e) => setMessage(e.target.value)}></textarea>
