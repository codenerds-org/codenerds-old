  ...
  return (
    <div className="h-[40rem] w-[100%]">
      <motion.div
        ...
        className="flex flex-col md:flex-row bg-[#22272e] justify-center md:justify-between"
      >
        <div className="flex flex-col justify-center ml-10">
          <h1 className="text-4xl md:text-6xl font-bold">Welcome,</h1>
          <h2 className="text-xl font-thin w-[80%]">
            We are team of passionate engineers who turn your vision into
            reality. We specialize in programming and digital solutions,
            providing tailored services that fit your unique needs. Contact us
            today.
          </h2>
